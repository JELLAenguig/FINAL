        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                    <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Update Information</h3>
                    <ProfileInfo />
                    <ChangePassword />
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <div className="flex space-x-8 mt-4">
                        ...
                        <div className="flex flex-col items-center">
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Light Mode</span>
                            <button
                                onClick={() => handleThemeChange("light")}
                                className={`flex items-center justify-center w-40 h-24 rounded-lg shadow-md ${
                                    theme === "light" ? "border-2 border-blue-500" : "border border-gray-300"
                        ...
                        {/* Dark Theme Button */}
                        <div className="flex flex-col items-center">
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Dark Mode</span>
                            <button
                                onClick={() => handleThemeChange("dark")}
                                className={`flex items-center justify-center w-40 h-24 rounded-lg shadow-md ${
                                    theme === "dark" ? "border-2 border-blue-500" : "border border-gray-300"
